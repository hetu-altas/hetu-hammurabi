...
每个上下文中都混入了事件分发 API。Harness 事件声明及其分发模式会生成到各自所属的[子系统页面](./../subsystems/core)。


### ctx.parallel(name, ...args) [​](#ctx-parallel-name-args)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L44)


### ctx.emit(name, ...args) [​](#ctx-emit-name-args)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L53)


### ctx.serial(name, ...args) [​](#ctx-serial-name-args)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L63)


### ctx.bail(name, ...args) [​](#ctx-bail-name-args)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L73)


### ctx.waterfall(name, ...args) [​](#ctx-waterfall-name-args)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L86)


### ctx.on(name, listener, options?) [​](#ctx-on-name-listener-options)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L97)


### ctx.once(name, listener, options?) [​](#ctx-once-name-listener-options)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L106)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L112)
...
[源码](https://github.com/deepseek-ai/deepseek-harness/blob/master/vendor/cordis/src/events.ts#L32)
