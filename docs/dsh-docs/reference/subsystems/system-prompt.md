...
### `ctx.systemPrompt` — `SystemPrompt` [​](#ctx-systemprompt-—-systemprompt)
...
### `system-prompt/*` events [​](#system-prompt-events)


[]()


#### `system-prompt/assemble` — waterfall [​](#system-prompt-assemble-—-waterfall)
...
#### `system-prompt/change` — emit [​](#system-prompt-change-—-emit)
