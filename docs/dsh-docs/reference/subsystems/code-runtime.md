...
## 绑定：宿主函数作为程序全局变量 [​](#绑定-宿主函数作为程序全局变量)
...
### `ctx.codeRuntime` — `CodeRuntime` (abstract seam) [​](#ctx-coderuntime-—-coderuntime-abstract-seam)
