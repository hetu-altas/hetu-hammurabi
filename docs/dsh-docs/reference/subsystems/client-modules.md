...
## bundle 路由与 index 转换 [​](#bundle-路由与-index-转换)
...
### `ctx.clientModules` — `ClientModuleRegistry` [​](#ctx-clientmodules-—-clientmoduleregistry)
