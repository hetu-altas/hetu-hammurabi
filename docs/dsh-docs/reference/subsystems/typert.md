...
### `ctx.apiProxy` — `ApiProxy` [​](#ctx-apiproxy-—-apiproxy)
...
Types: [TypertContribution](./invariants) · [TypertFace](./invariants) · [TypertPackageFilter](./invariants) · [TypertPackageRecord](./invariants) · [TypertSchemaFilter](./invariants) · [TypertSchemaRecord](./invariants)
...
### `ctx.typertGateway` — `TypertGatewayService` [​](#ctx-typertgateway-—-typertgatewayservice)
