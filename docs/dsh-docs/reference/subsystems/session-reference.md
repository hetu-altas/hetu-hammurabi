...
### `ctx.sessionReferenceResolver` — `SessionReferenceResolver` [​](#ctx-sessionreferenceresolver-—-sessionreferenceresolver)
...
Types: [Agent](./core) · [ContentBlock](./llm-streaming)
