...
# 2. 生命周期与 effect [​](#_2-生命周期与-effect)
...
你会在[第 6 章](./06-composition-and-hmr)再次遇到 PENDING，它通常就是「为什么我的插件没有输出」的答案。


## 已经属于 effect 的操作 [​](#已经属于-effect-的操作)
