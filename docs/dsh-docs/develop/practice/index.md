...
本文分为两部分：先参考三种角色能力模式的概念，再通过高级教程构建一项能力。请先完成[基础插件路径](./../basic/)和[服务教程](./../framework/service)。
...
当前内置系列及其包链接由[能力 seam 参考](./../../reference/capability-seams)负责。


## 教程：开发三种角色的能力 [​](#教程-开发三种角色的能力)


### 第一步：编写 Service Definition [​](#第一步-编写-service-definition)
...
### 第二步：编写 Service Provider [​](#第二步-编写-service-provider)
...
### 在 cordis.yml 中组合 [​](#在-cordis-yml-中组合)
