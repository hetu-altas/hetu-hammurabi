...
## Harness 内置服务 [​](#harness-内置服务)


服务名、公开方法和源码位置由仓库自动生成到各服务的[子系统页面](./../../reference/subsystems/core)。开发插件时应以这些生成区块和服务的 TypeScript 接口为准，不要维护另一份静态清单。
