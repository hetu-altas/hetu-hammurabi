...
> — Excerpts from the [Charter Programming Manifesto](manifesto.md)
...
- Echoing Tenet IV of the [Manifesto](manifesto.md): "Tools may change, models may change; the constitution never dies, and the system lives forever."
...
├── 宪章编程宣言.md                    # Charter Programming Manifesto (Chinese) — see manifesto.md
